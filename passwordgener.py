#!/usr/bin/env python3
#-*- encoding:utf-8 -*-
'''this programme has a function which generates a password of desired length and contains letters, digits and special symbols.
It tests the function 5 times with different arguments.'''
